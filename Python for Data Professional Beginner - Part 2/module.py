...
# Chapter2 - String Manipulation dengan Python
...
# Chapter4 - Manipulasi Berkas Teks dan Library Matematika pada Python
...
file.writelines(["Sekarang kita belajar menulis dengan menggunakan Python", 
